...
class RomaniaMapGUI:
    def __init__(self, root):
        ...
        self.source_label = tk.Label(self.root, text="Source", font=("Arial", 14))
        self.source_label.pack(pady=10)
        self.source_entry = tk.Entry(self.root, font=("Arial", 12))
        self.source_entry.pack()

        self.destination_label = tk.Label(self.root, text="Destination", font=("Arial", 14))
        self.destination_label.pack(pady=10)
        self.destination_entry = tk.Entry(self.root, font=("Arial", 12))
        self.destination_entry.pack()

        self.submit_button = tk.Button(self.root, text="Submit", command=self.visualize_bfs, font=("Arial", 14))
    ...
    def visualize_bfs(self):
        source_city = self.source_entry.get().capitalize()
        destination_city = self.destination_entry.get().capitalize()
